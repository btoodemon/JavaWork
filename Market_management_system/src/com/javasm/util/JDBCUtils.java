...
import com.javasm.constant.JDBCConstant;
...
public class JDBCUtils {
    ...
    public static Connection getConn() {
        try {
            ...
            if (conn == null || conn.isClosed()) {
                ...
                Class.forName(JDBCConstant.DRIVER); //加载驱动
                //获取连接.
                conn = DriverManager.getConnection(JDBCConstant.URL, JDBCConstant.USERNAME, JDBCConstant.PWD);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static <T> T get(Connection connection,String sql, Class<T> claz, Object... params) {
        T t = null;
        try {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            Class.forName(JDBCConstant.DRIVER); //加载驱动
            //获取连接.
            connection = DriverManager.getConnection(JDBCConstant.URL, JDBCConstant.USERNAME, JDBCConstant.PWD);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return connection;
